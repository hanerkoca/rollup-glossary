...
It is a decentralized and Ethereum-aligned rollup solution that leverages the benefits of a based rollup, inheriting L1 decentralization, simplicity, and liveness, and further enhances scalability by introducing out-of-the-box, native Ethereum L1 dapp scaling through the addition of booster rollups, which shard the execution of transactions and storage for efficient scaling.
